    ...
    <div>
      ...
      <div className="flex flex-col min-h-screen">
        <div className="flex-grow flex flex-col md:flex-row">
          <div className="flex w-full md:w-1/2 bg-gray-100 p-8">
            <div className="w-full p-4">
              ...
              <form>
                <div className="mb-4">
                  ...
                  <select id="department" className="w-full md:max-w-sm lg:max-w-md px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">
                ...
                <div className="mb-4">
                  ...
                  <input type="text" id="subject" className="w-full md:max-w-sm lg:max-w-md px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" />
                </div>
                <div className="mb-4">
                  <label htmlFor="message" className="block text-gray-700">Mensagem</label>
                  <textarea id="message" className="w-full md:max-w-sm lg:max-w-md px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" rows="4"></textarea>
                </div>
                <button type="submit" className="w-full md:w-auto bg-green-500 text-white py-2 px-4 rounded-lg hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500">Enviar</button>
              </form>
            </div>
          </div>
          <div className="flex w-full md:w-1/2 bg-white p-8">
            <div className="w-full p-4">
